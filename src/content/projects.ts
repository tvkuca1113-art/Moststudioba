...
export type DemoProject = {
  ...
  /** The primary functional flow visitors can operate in the demo. */
...
export const demoProjects: DemoProject[] = [
  {
    ...
    shortName: "Hrast",
    sector: {
      bs: "Stolarija i montaža po mjeri",
      de: "Tischlerei und Montage nach Maß",
    },
    tagline: {
    ...
    decisions: [
      {
        title: {
          bs: "Materijal u prvom planu",
          de: "Das Material im Mittelpunkt",
        },
        body: {
          bs: "Topla svijetla podloga, velika fotografija i mirna serifna tipografija daju materijalu prostor. Konfigurator zatim pretvara inspiraciju u konkretan odabir.",
          de: "Ein warmer heller Hintergrund, ein großes Foto und ruhige Serifentypografie geben dem Material Raum. Der Konfigurator übersetzt die Inspiration anschließend in eine konkrete Auswahl.",
        },
      },
      {
        title: {
          bs: "Uz svaki komad piše šta ulazi u posao",
          de: "Bei jedem Stück steht, was zum Auftrag gehört",
        },
        body: {
      ...
      {
        title: {
          bs: "Uzorci obrade, jasno nazvani",
          de: "Oberflächenmuster, klar benannt",
        },
        body: {
      ...
      {
        title: {
          bs: "Mjerenje kao prvi korak, ne poziv",
          de: "Aufmaß als erster Schritt, nicht der Anruf",
        },
        body: {
    ...
    annotations: [
      {
        id: "offer",
        title: {
          bs: "Ponuda je jasna već na prvom ekranu.",
      ...
      },
      {
        id: "services",
        title: {
          bs: "Usluge se mogu pregledati bez traženja.",
          de: "Die Leistungen lassen sich ohne Suchen überblicken.",
        },
        body: {
      ...
      },
      {
        id: "contact",
        title: {
          bs: "Kontakt je dostupan u trenutku odluke.",
          de: "Der Kontakt ist im Moment der Entscheidung da.",
        },
        body: {
    ...
    tryIt: {
      title: {
        bs: "Konfigurator namještaja i sažetak projekta",
        de: "Möbelkonfigurator und Projektübersicht",
      },
      body: {
        bs: "Odaberite vrstu namještaja, završnu obradu, širinu i dodatne usluge. Sažetak se mijenja uz vaš odabir i može se preuzeti kao datoteka za prvi razgovor.",
        de: "Wählen Sie Möbelart, Oberfläche, Breite und Zusatzleistungen. Die Übersicht folgt Ihrer Auswahl und lässt sich als Datei für das Erstgespräch herunterladen.",
      },
    },
...

  {
    ...
    decisions: [
      {
        title: {
          bs: "Mirna podloga i velika veličina teksta",
          de: "Ruhiger Untergrund und große Schrift",
        },
        body: {
      ...
      {
        title: {
          bs: "Odabir po tegobi, ne po stručnom nazivu",
          de: "Auswahl nach Beschwerde, nicht nach Fachbegriff",
        },
        body: {
      ...
      {
        title: {
          bs: "Usluge s trajanjem, ne samo s nazivom",
          de: "Leistungen mit Dauer, nicht nur mit Namen",
        },
        body: {
      ...
      {
        title: {
          bs: "Traka za zakazivanje koja prati čitanje",
          de: "Terminleiste, die beim Lesen mitläuft",
        },
        body: {
    ...
    tryIt: {
      title: {
        bs: "Zakazivanje termina u tri koraka",
        de: "Terminwahl in drei Schritten",
      },
      body: {
        bs: "Isprobajte odabir usluge, datuma i vremena, zatim pregledajte podatke i završite probno zakazivanje. Promjene odabira ažuriraju sažetak; stvarna rezervacija se ne kreira.",
        de: "Testen Sie Leistung, Datum und Uhrzeit, prüfen Sie die Angaben und schließen Sie die Demo-Buchung ab. Änderungen aktualisieren die Übersicht; es entsteht keine echte Reservierung.",
      },
    },
...

  {
    ...
    decisions: [
      {
        title: {
          bs: "Uredničko slaganje umjesto kartica",
          de: "Redaktioneller Satz statt Kartenraster",
        },
        body: {
      ...
      {
        title: {
          bs: "Tri pitanja umjesto tri paragrafa",
          de: "Drei Fragen statt drei Absätze",
        },
        body: {
      ...
      {
        title: {
          bs: "Bez brojki koje ništa ne znače",
          de: "Keine Zahlen, die nichts bedeuten",
        },
        body: {
      ...
      {
        title: {
          bs: "Ista dva pisma, drugačiji ton",
          de: "Dieselben zwei Schriften, anderer Ton",
        },
        body: {
    ...
    tryIt: {
      title: {
        bs: "Interaktivni plan saradnje",
        de: "Interaktiver Plan für die Zusammenarbeit",
      },
      body: {
        bs: "Prođite kroz tri pitanja, pogledajte predloženi fokus i dnevni red sastanka. Odaberite pokazni raspored, izmijenite odgovore ili preuzmite svoj plan.",
        de: "Beantworten Sie drei Fragen und sehen Sie Schwerpunkt und Gesprächsagenda. Wählen Sie einen Beispielrhythmus, ändern Sie Antworten oder laden Sie Ihren Plan herunter.",
      },
    },
...
export const demoProjectBySlug = new Map(
  demoProjects.map((project) => [project.slug, project]),
);
