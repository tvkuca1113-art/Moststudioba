  ...
  bs: {
    ...
    coverage: {
      ...
      sections: [
        ...
        { id: "gradovi", title: "Isti pristup za ostale gradove u BiH", paragraphs: ["Saradnja je dostupna firmama i obrtima širom Bosne i Hercegovine, uključujući manja mjesta. Grad ne mijenja način isporuke; važniji su publika, ponuda i složenost projekta.", "Za posao koji radi u više gradova prvo utvrđujemo postoji li različita ponuda ili stvarni lokalni sadržaj. Posebna stranica za grad ima smisla kada posjetiocu daje korisne informacije, kao što su stvarno područje dostave, tim ili izvedeni radovi. Samo ponavljanje imena gradova ne objašnjava vašu vrijednost."] },
  ...
  de: {
    ...
    coverage: {
      ...
      sections: [
        ...
        { id: "gradovi", title: "Derselbe Ansatz für andere Städte in BiH", paragraphs: ["Die Zusammenarbeit steht Unternehmen und Betrieben in ganz Bosnien-Herzegowina offen, auch in kleineren Orten. Die Stadt verändert die Online-Abwicklung nicht; Zielgruppe, Angebot und Komplexität sind entscheidender.", "Bedient ein Unternehmen mehrere Städte, prüfen wir zunächst, ob sich Angebot oder lokale Inhalte unterscheiden. Eine eigene Stadtseite ist sinnvoll, wenn sie nützliche Informationen wie tatsächliche Liefergebiete, Teams oder ausgeführte Arbeiten enthält. Stadtnamen allein erklären keinen Nutzen."] },
