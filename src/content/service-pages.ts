...
export const contentPageKeys = ["website", "webshop", "redesign", "coverage", "pricing"] as const;
...
export const contentPages: Record<Locale, Record<ContentPageKey, ContentPage>> = {
  bs: {
    website: {
      ...
      heading: "Vaša ponuda. Jasna od prvog klika.",
      ...
      faq: [
        ...
        { question: "Da li je moguće završiti za sedam dana?", answer: "Za mali i jasno definisan obim s pripremljenim materijalima može biti moguće. Dostupnost i realan rok potvrđujemo nakon pregleda zahtjeva; složenije funkcije i dodatni jezici traže zaseban plan." },
      ],
    },
    webshop: {
      ...
      heading: "Od dobrog proizvoda do jasne narudžbe.",
    ...
    redesign: {
      ...
      heading: "Vaš posao je napredovao. Vrijeme je da ga web prati.",
      ...
      sections: [
        { id: "pregled", title: "Prvo utvrđujemo gdje posjetilac zapinje", paragraphs: ["Provjeravamo razumljivost ponude, navigaciju, čitljivost, mobilni meni, kontakt i važne obrasce. Ako imate podatke iz Search Consolea ili analitike, koristimo ih da razlikujemo stvarni problem od pretpostavke.", "Nekada je dovoljna jasnija uslužna stranica i bolji kontakt. Nekada postojeći sistem ograničava promjene pa je potrebna nova izrada. Preporuku vežemo za ciljeve i održavanje, ne samo za izgled."] },
    ...
    coverage: {
      title: "Web dizajn za firme širom BiH: online saradnja | MOST Studio",
      description: "Online izrada web stranica za Mostar, Sarajevo, Banju Luku, Tuzlu i ostatak BiH. MOST Studio: dizajn, webshop i redizajn uz jasan dogovor na daljinu.",
      eyebrow: "ONLINE SARADNJA · BOSNA I HERCEGOVINA",
      heading: "Vaš posao u BiH. Naša saradnja online.",
      ...
      summary: ["Mostar i Hercegovina", "Sarajevo, Banja Luka, Tuzla i drugi gradovi", "Online dogovor na bosanskom ili njemačkom"],
      sections: [
        ...
        { id: "gradovi", title: "Isti pristup za ostale gradove u BiH", paragraphs: ["Saradnja je dostupna firmama iz Sarajeva, Banje Luke, Tuzle, Zenice, Bihaća, Bijeljine, Brčkog, Trebinja i drugih mjesta u Bosni i Hercegovini. Grad ne mijenja način isporuke; važniji su publika, ponuda i složenost projekta.", "Za posao koji radi u više gradova prvo utvrđujemo postoji li različita ponuda ili stvarni lokalni sadržaj. Posebna stranica za grad ima smisla kada posjetiocu daje korisne informacije, kao što su stvarno područje dostave, tim ili izvedeni radovi. Samo ponavljanje imena gradova ne objašnjava vašu vrijednost."] },
      ...
      faq: [
        { question: "Imate li ured za dolazak u Mostaru?", answer: "Saradnju vodimo online; ne predstavljamo ovu uslugu kao fizički ured za posjete u Mostaru ili drugim gradovima. Javite nam se emailom ili preko Instagrama." },
    ...
    pricing: {
      ...
      heading: "Prije pitanja koliko košta, odredimo šta treba raditi.",
  ...
  de: {
    website: {
      ...
      heading: "Ihr Angebot. Vom ersten Klick an verständlich.",
      ...
      faq: [
        ...
        { question: "Ist eine Fertigstellung in sieben Tagen möglich?", answer: "Bei einem kleinen, klar definierten Umfang und fertigen Materialien kann das möglich sein. Verfügbarkeit und Termin bestätigen wir erst nach Prüfung. Komplexere Funktionen und zusätzliche Sprachen brauchen einen eigenen Zeitplan." },
      ],
    },
    webshop: {
    ...
    coverage: {
      ...
      description: "Online-Website-Erstellung für Mostar, Sarajevo, Banja Luka, Tuzla und ganz BiH. MOST Studio: Webdesign, Onlineshop und Relaunch mit klarer Zusammenarbeit.",
      eyebrow: "ONLINE-ZUSAMMENARBEIT · BOSNIEN-HERZEGOWINA",
      heading: "Ihr Geschäft in BiH. Unsere Zusammenarbeit online.",
      ...
      summary: ["Mostar und Herzegowina", "Sarajevo, Banja Luka, Tuzla und weitere Städte", "Online-Abstimmung auf Bosnisch oder Deutsch"],
      sections: [
        ...
        { id: "gradovi", title: "Derselbe Ansatz für andere Städte in BiH", paragraphs: ["Die Zusammenarbeit steht Unternehmen aus Sarajevo, Banja Luka, Tuzla, Zenica, Bihać, Bijeljina, Brčko, Trebinje und weiteren Orten in Bosnien-Herzegowina offen. Die Stadt verändert die Online-Abwicklung nicht; Zielgruppe, Angebot und Komplexität sind entscheidender.", "Bedient ein Unternehmen mehrere Städte, prüfen wir zunächst, ob sich Angebot oder lokale Inhalte unterscheiden. Eine eigene Stadtseite ist sinnvoll, wenn sie nützliche Informationen wie tatsächliche Liefergebiete, Teams oder ausgeführte Arbeiten enthält. Stadtnamen allein erklären keinen Nutzen."] },
      ...
      faq: [
        { question: "Kann ich ein Büro in Mostar besuchen?", answer: "Unsere Zusammenarbeit findet online statt. Wir stellen dieses Angebot nicht als besuchbares Büro in Mostar oder anderen Städten dar. Kontaktieren Sie uns per E-Mail oder Instagram." },
    ...
    pricing: {
      ...
      heading: "Vor der Preisfrage steht die Aufgabe Ihrer Website.",
...
export const pageLabels: Record<Locale, Record<ContentPageKey, string>> = {
  bs: { website: "Izrada web stranica", webshop: "Izrada webshopa", redesign: "Redizajn web stranica", coverage: "Online saradnja u BiH", pricing: "Vodič o cijeni" },
  de: { website: "Website-Erstellung", webshop: "Onlineshop", redesign: "Website-Relaunch", coverage: "Online-Zusammenarbeit in BiH", pricing: "Kostenratgeber" },
};
