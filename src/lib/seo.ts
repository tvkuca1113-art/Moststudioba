    ...
    "@graph": [
      {
        ...
        ...(isService ? { mainEntity: { "@id": `${url}#service` } } : page.publishedOn ? { mainEntity: { "@id": `${url}#article` } } : {}),
      },
      {
      ...
      ...(page.publishedOn ? [{
        ...
        headline: page.heading, description: page.description,
        inLanguage: htmlLang[locale], datePublished: page.publishedOn,
        author: { "@type": "Organization", "@id": `${siteUrl}/#organization`, name: site.name, url: siteUrl },
        publisher: { "@id": `${siteUrl}/#organization` },
        mainEntityOfPage: { "@id": `${url}#webpage` },
        ...(page.sources ? { citation: page.sources.map(source => source.href) } : {}),
      }] : []),
      ...(isService ? [{
