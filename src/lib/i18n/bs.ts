...
export const bs = {
  ...
  hero: {
    ...
    galleryHint: "Odaberite koncept da vidite kako izgleda.",
    figureLabel: "Snimak naslovne stranice demo koncepta koji je izradio MOST Studio.",
  },
  ...
  projects: {
    ...
    wantThis: "Želite ovakav pristup za svoj posao?",
    wantThisBody: "Recite nam čime se bavite i kome se obraćate. Predložićemo strukturu koja odgovara vašem poslu.",
  ...
  process: {
    ...
    detail: "Detaljno o svakom koraku",
  ...
  brief: {
    ...
    editedNotice: "Uredili ste poruku, pa više ne prati odgovore iznad.",
    regenerate: "Sastavi ponovo iz odgovora",
    copy: "Kopiraj poruku",
    ...
    stepsLabel: "Tri koraka do poruke",
    step1: "Pripremite",
    step1Body: "Odgovorite na tri kratka pitanja.",
    step2: "Kopirajte",
    step2Body: "Poruku sastavljamo za vas — pregledajte je i uredite ako treba.",
    step3: "Otvorite Instagram",
    step3Body: "Nalijepite poruku u razgovor s našim profilom i pošaljite je.",
    stepDone: "Gotovo",
    copyFirst: "Prvo kopirajte poruku, pa je zalijepite u razgovor.",
    errors: {
    ...
    messageGoal: "Najvažnije nam je da {goal}.",
    ...
    // Each option finishes "Najvažnije nam je da …" as an ordinary sentence.
    goalText: {
      contact: "nam se posjetioci lakše jave",
      services: "posjetioci lako pregledaju naše usluge",
      appointment: "posjetioci mogu zakazati termin",
      work: "posjetioci vide naše radove",
    },
  },
