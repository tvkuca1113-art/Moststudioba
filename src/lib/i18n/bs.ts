...
export const bs = {
  ...
  hero: {
    ...
    lead: "Dizajn i izrada za firme koje žele jasnije predstaviti svoj posao i olakšati prvi kontakt.",
    ctaPrimary: "Razgovarajmo o projektu",
    ctaSecondary: "Pogledajte radove",
    support: "Web dizajn · Izrada · Redizajn",
    markets: "BiH + Njemačka",
    figureLabel: "Snimak naslovne stranice demo koncepta koji je izradio MOST Studio, na računaru i na mobitelu.",
